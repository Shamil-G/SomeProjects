...
--          r.type_emp_kaz||', '||
          e.type_emp_kaz||', '||c.short_descr_kaz
          else o.short_descr||
--          ', '||r.short_descr||
          ', '||e.short_descr||', '||c.short_descr
        end
...
--/*
  ...
  and   trunc(r.beg_time_testing,'dd')>=to_date('03.02.2015','dd.mm.yyyy')
  and   trunc(r.end_time_testing,'dd')<=to_date('04.02.2015','dd.mm.yyyy')
