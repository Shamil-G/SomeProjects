create or replace package secmgr.sadmin as
  ...
  /* TODO enter package declarations (types, exceptions, methods etc) here */
    ...
    procedure emp_new(iid_emp number, iid_region number, iid_pc number,
                        ...
                        ipassword varchar2, --iattr varchar2,
                        iname varchar2,
    ...
    procedure gparams_new(iname varchar2, ivalue varchar2);
    procedure gparams_upd(iname varchar2, ivalue varchar2);
    procedure gparams_del(iname varchar2);

end sadmin;
/

create or replace package body secmgr.sadmin as
  ...
  begin
    ...
    insert into secmgr.list_workstation(id_pc , id_region , ip_addr , active, num_device , type_device, date_op )
  ...
  begin
    ...
    as
    begin
    insert into secmgr.emp(id_emp, id_region, id_pc,
...
--        e.attr=iattr,
    ...
    as
    begin
    insert into gparams(name, value) values(iname, ivalue);
    gsec_ctx.init;
    end gparams_new;
